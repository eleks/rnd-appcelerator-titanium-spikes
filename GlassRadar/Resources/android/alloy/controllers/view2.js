function Controller() {
    ...
    __alloyId3.push($.__views.sectionFruit);
    ...
    __alloyId3.push($.__views.sectionVeg);
    ...
    $.__views.sectionVeg.add($.__views.__alloyId7);
    $.__views.sectionFish = Ti.UI.createTableViewSection({
        id: "sectionFish",
        headerTitle: "Fish"
    });
    __alloyId3.push($.__views.sectionFish);
    ...
    $.__views.sectionFish.add($.__views.__alloyId9);
